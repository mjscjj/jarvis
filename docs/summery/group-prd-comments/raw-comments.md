...
| # | 引用上下文 | 评论内容 | 时间(UTC) |
|---|---|---|---|
| 1 | 【待评估】tab里，新增 「待领取」线索选项 | 这里面看看怎么强化引导 | 2026-08-26 06:12 |
| 2 | 超管弹窗文案 - 开启认领功能 | 这个弹窗能关闭吗 | 2026-08-26 06:13 |
| 3 | 日了解认领情况>认领线索 | 在哪能看领了多少条 | 2026-08-26 06:14 |
| 4 | 日了解认领情况>认领线索 | 这里核心逻辑是不是也不只是认领，认领不建联有用么 | 2026-08-26 06:15 |
| 5 | 开启认领： 开启后继续配置以下功能 | 为啥要做这个功能，预期谁是不打开的 | 2026-09-02 03:56 |
| 6 | - 开启认领：未开启认领时，只有公会长/超管可以看到「待认领」线索，线索均由管理者下发 | 为啥只能二选一 | 2026-09-02 03:56 |
| 7 | 被其他人领取了的线索动画消失 | 这个要瞬间消失吗 | 2026-09-02 03:58 |


<a id="2"></a>
## 2. 【CN Growth // 公会增长】CN Buddy Program 2nd phase iteration // 公会服务费功能二期迭代

- 链接：https://bytedance.larkoffice.com/wiki/ELJhwA2kviVch9kIzVMcqncInfc
- 类型：DOCX｜Owner：Ethan Ng｜出现群：组内评审群
- 本人评论数：7

| # | 引用上下文 | 评论内容 | 时间(UTC) |
|---|---|---|---|
| 1 | 材料清单说明和文案： | 啥样的内容，有指导吗 | 2026-07-08 06:01 |
| 2 | 审批公会伙伴计划调整申请】 | 我记得这个决策不是说争议才批 | 2026-07-08 06:06 |
| 3 | 审批公会伙伴计划调整申请】 | 现在是每个变化比例都要批吗 | 2026-07-08 06:06 |
| 4 | 公会申请开通飞书通知】 | 这个也是每个都要批吗 | 2026-07-08 06:06 |
| 5 | 公会POC | 权限以及使用规范是啥 | 2026-07-29 05:07 |
| 6 | 80 | 90分？ | 2026-07-29 05:08 |
| 7 | 0–95% | 100%？ | 2026-07-29 05:09 |


<a id="3"></a>
## 3.  [Agency Growth]TCN conference H5

- 链接：https://bytedance.my.larkoffice.com/docx/IgOPd0RojoESa8xnAkSmzUuyy1d
- 类型：DOCX｜Owner：陈渝腊｜出现群：Backstage初评群
- 本人评论数：6

| # | 引用上下文 | 评论内容 | 时间(UTC) |
|---|---|---|---|
| 1 | [图片] | 这个是不是把公会的名字展示一下 | 2026-06-25 02:38 |
| 2 | [图片] | 这个引导语加一下，为啥人家要看白皮书 | 2026-06-25 02:38 |
| 3 | [图片] | 这个交互左右滑不是很友好 | 2026-06-25 02:38 |
| 4 | [图片] | 这个页面是for啥 | 2026-06-25 02:41 |
| 5 | [图片] | 设计逻辑是啥 | 2026-06-25 02:41 |
| 6 | 邀请制：仅提前邀请的名单可参与，无法由用户在H5预约 | 邀请制要不就对非邀请人不参与了吧 | 2026-06-25 02:42 |
...
| # | 引用上下文 | 评论内容 | 时间(UTC) |
|---|---|---|---|
| 1 | 客服Agent相关指标 | 这块对齐客服平台 | 2026-08-19 05:57 |
| 2 | Bax 需要在跟用户对话期间，在特定情况下答复之后，提供用户可转人工选项具体明细&策略 - | 有点没太理解，不是说不和Bax融合 | 2026-08-19 06:06 |
| 3 | 客服入口 vs Bax：定位有什么不同？ | 讲一下 | 2026-08-26 06:08 |
| 4 | 回答正文内容要求： | 这个是不是增加一些情绪价值先 | 2026-08-26 06:09 |
| 5 | [图片] | 讲一下 | 2026-08-26 06:19 |
...
| # | 引用上下文 | 评论内容 | 时间(UTC) |
|---|---|---|---|
| 1 | 仅“Provide more details”涉及算法模型，评分权重10%，本次暂不支持，其他评分标准字段都可用 | 怎么理解 | 2026-07-22 06:03 |
| 2 | eads 服务在 US-TTP / EU-TTP 各部署一份，US 内广线索落 US-TTP，EU 内广线索落 EU-TTP，数据本地闭环 | 后续谁可以使用跟进 | 2026-07-22 06:05 |
| 3 | S-TTP / EU-TTP 各部署一份，自动化工作流本地调用 | 我记得说这个成本很高 | 2026-07-22 06:05 |
| 4 | After | 能按照BPO的流程画个跟进图吗 | 2026-07-22 06:05 |


<a id="6"></a>
## 6. 【公会主播】PGC专项：公会主播中心新增Star Creator模块

- 链接：https://bytedance.sg.larkoffice.com/docx/OsPqdYeB9oC8D1xDza7l43LTg4b
- 类型：DOCX｜Owner：吴阳｜出现群：组内评审群
- 本人评论数：4

| # | 引用上下文 | 评论内容 | 时间(UTC) |
|---|---|---|---|
| 1 | 画面表现：基于直播间的声画动态质量表现，评估直播间制作水平对观众的吸引能力，通过模型进行表现打分 | 这个好像也跟概念互动有关联，pending | 2026-08-05 06:23 |
| 2 | 新增「star creator达标天数」字段 | 这不应该是个固定指标吧 | 2026-08-19 03:55 |
| 3 | 新增「star creator达标天数」字段 | 应该是个活动页概念？ | 2026-08-19 03:55 |
| 4 | [图片] | 这是活动，还是政策的 | 2026-08-19 03:58 |
...
<a id="10"></a>
## 10. [公会主播] 入会即有LIVE Studio权限 // Users gain immediate LIVE Studio permission upon joining the CN

- 链接：https://bytedance.larkoffice.com/wiki/GNhQwSRQfic5VckYN88cY3CFnLh
- 类型：DOCX｜Owner：周琳｜出现群：Backstage初评群
- 本人评论数：2
...
| # | 引用上下文 | 评论内容 | 时间(UTC) |
|---|---|---|---|
| 1 | 建议总数上限为6条，优先展示P0建议，P1建议补充 | 6条会失焦吧 | 2026-06-11 01:21 |
| 2 | 重复建议的处理逻辑 | 给点例子 | 2026-06-11 01:23 |


<a id="13"></a>
## 13. [Agency Growth]C端活动联动公会赛//TCN campaign bond to creator campaign 

- 链接：https://bytedance.my.larkoffice.com/docx/LYsxdubdroTUOixIHtemsaWIyMg
- 类型：DOCX｜Owner：陈渝腊｜出现群：Backstage初评群
- 本人评论数：1

| # | 引用上下文 | 评论内容 | 时间(UTC) |
|---|---|---|---|
| 1 | 无论B活动开始早于或者晚于C活动 | 没看懂，B活动是不是不能早于C啊 | 2026-07-29 05:17 |
