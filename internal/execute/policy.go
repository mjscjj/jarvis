...
//   - Every non-blank action_type uses the same execution path.
...
// danger-full-access for all types; the real safety boundary is M5's judgment
// under the file-backed policy plus the proposal/approval state carrier.
