...
func TestWeeklyNextOccurrence(t *testing.T) {
	for _, tc := range []struct {
		...
		{"Sunday zero", "Asia/Shanghai", "2026-09-12T20:00:00Z", "09:00", "2026-09-13T09:00:00+08:00", 0},
		...
		{"DST starts", "America/New_York", "2026-03-01T09:00:00-05:00", "09:00", "2026-03-08T09:00:00-04:00", 0},
		{"DST ends", "America/New_York", "2026-10-25T09:00:00-04:00", "09:00", "2026-11-01T09:00:00-05:00", 0},
	} {
...
func TestWeeklyValidationAndFieldCleanup(t *testing.T) {
	clock, badClock, day, negative, tooLarge := "09:00", "25:00", 0, -1, 7
	for _, tc := range []struct {
		day   *int
		clock *string
	}{
...
func TestWeeklyLifecycle(t *testing.T) {
	...
	if created.Weekday == nil || *created.Weekday != 0 {
		t.Fatalf("Sunday not persisted: %+v", created)
	}
	listed, err := service.List(ctx, ListFilter{Limit: 10})
	if err != nil || len(listed) != 1 || listed[0].Weekday == nil || *listed[0].Weekday != 0 {
