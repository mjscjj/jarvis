...
func TestUpdateRuntimeSettings(t *testing.T) {
	...
	body := []byte(`{"analysis_cli":"codex","analysis_model":"gpt","analysis_timeout_seconds":600,"extract_enabled":true,"extract_engine":"codex","extract_reasoning_effort":"low","decide_enabled":true,"decide_mode":"codex","decide_reasoning_effort":"medium","execute_auto_enabled":true,"execute_cli":"traex","execute_model":"exec","execute_reasoning_effort":"high","execute_timeout_seconds":1800,"execute_stale_minutes":45,"execute_concurrency":3,"chat_enabled":true,"chat_model":"chat","chat_reasoning_effort":"medium","chat_timeout_seconds":600,"scheduled_task_enabled":true,"daily_digest_enabled":true}`)
