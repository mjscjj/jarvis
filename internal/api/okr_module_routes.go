...
func RegisterOKRModuleRoutes(h *server.Hertz, deps OKRModuleDependencies) error {
	...
	h.GET("/api/okr/plans", requireEnabled, ListOKRPlans(deps.Workspace))
	h.POST("/api/okr/plans", requireEnabled, CreateOKRPlan(deps.Workspace))
	h.GET("/api/okr/plans/:plan_id", requireEnabled, GetOKRPlan(deps.Workspace))
	h.PUT("/api/okr/plans/:plan_id", requireEnabled, ReplaceOKRPlan(deps.Workspace))
	h.DELETE("/api/okr/plans/:plan_id", requireEnabled, DeleteOKRPlan(deps.Workspace))
	...
	h.POST("/api/okr/feishu-documents", requireEnabled, CreateOKRDocument(deps.Documents))
	...
	h.PUT("/api/okr/krs/:kr_id", requireEnabled, ReplaceCoreKR(deps.Workspace))
	h.PUT("/api/okr/krs/:kr_id/definition", requireEnabled, ReplaceKRDefinition(deps.Workspace))
	h.PUT("/api/okr/krs/:kr_id/tags", requireEnabled, ReplaceKRTags(deps.Workspace))
	h.PUT("/api/okr/points/:point_id/tags", requireEnabled, ReplacePointTags(deps.Workspace))
...
func RegisterWeeklyReportModuleRoutes(h *server.Hertz, deps WeeklyReportModuleDependencies) error {
	...
	h.DELETE("/api/weekly-report/comments/:comment_id", requireEnabled, DeleteComment(deps.Workspace))
	h.GET("/api/weekly-report/follow-ups", requireEnabled, GetFollowUps(deps.Workspace))
	h.GET("/api/weekly-report/follow-ups/:follow_up_id", requireEnabled, GetFollowUp(deps.Workspace))
	h.POST("/api/weekly-report/follow-ups", requireEnabled, CreateFollowUp(deps.Workspace))
	h.PUT("/api/weekly-report/follow-ups/:follow_up_id", requireEnabled, UpdateFollowUp(deps.Workspace))
	h.DELETE("/api/weekly-report/follow-ups/:follow_up_id", requireEnabled, DeleteFollowUp(deps.Workspace))
	...
	h.POST("/api/weekly-report/reminder-batches/generate", requireEnabled, GenerateReminderBatch(deps.Workspace))
	h.POST("/api/weekly-report/feishu-documents", requireEnabled, CreateOKRDocument(deps.Documents))
	...
	h.POST("/api/weekly-report/points/:point_id/meego-confirm", requireEnabled, ConfirmMeegoProgress(deps.Workspace))
	h.GET("/api/weekly-report/krs/:kr_id", requireEnabled, GetWeeklyReportKR(deps.Workspace))
	h.PUT("/api/weekly-report/krs/:kr_id/core", requireEnabled, ReplaceWeeklyKRCore(deps.Workspace))
	h.PUT("/api/weekly-report/scores/:target_kind/:target_id", requireEnabled, ReplaceWeeklyScore(deps.Workspace))
	h.DELETE("/api/weekly-report/scores/:target_kind/:target_id", requireEnabled, DeleteWeeklyScore(deps.Workspace))
	h.POST("/api/weekly-report/points/:point_id/progress", requireEnabled, CreateWeeklyProgressEntry(deps.Workspace))
	h.PUT("/api/weekly-report/progress/:progress_id", requireEnabled, UpdateWeeklyProgressEntry(deps.Workspace))
	h.DELETE("/api/weekly-report/progress/:progress_id", requireEnabled, DeleteWeeklyProgressEntry(deps.Workspace))
	return nil
}
