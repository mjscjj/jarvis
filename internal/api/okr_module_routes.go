...
func RegisterBizOKRModuleRoutes(h *server.Hertz, deps BizOKRModuleDependencies) error {
	...
	requirePlanViewer := RequireOKRPlanAccess(deps.Identity, okrPlanAccessViewer)
	requirePlanEditor := RequireOKRPlanAccess(deps.Identity, okrPlanAccessEditor)
	...
	h.GET("/api/biz-okr/plans", requireEnabled, requirePlanViewer, ListOKRPlans(deps.Workspace))
	h.POST("/api/biz-okr/plans", requireEnabled, requirePlanEditor, recordOKRActivity(deps.Activity, okrActivitySpec{Surface: "plan", Action: "plan_created"}, CreateOKRPlan(deps.Workspace)))
	h.GET("/api/biz-okr/plans/:plan_id", requireEnabled, requirePlanViewer, GetOKRPlan(deps.Workspace))
	h.GET("/api/biz-okr/plans/:plan_id/comments", requireEnabled, requirePlanViewer, GetOKRPlanComments(deps.Workspace))
	h.POST("/api/biz-okr/plans/:plan_id/comments", requireEnabled, requirePlanViewer, CreateOKRPlanComment(deps.Workspace))
	h.POST("/api/biz-okr/plans/:plan_id/objectives", requireEnabled, requirePlanEditor, recordOKRActivity(deps.Activity, okrActivitySpec{Surface: "plan", Action: "objective_created", TargetParam: "plan_id"}, CreateOKRPlanObjective(deps.Workspace)))
	h.PATCH("/api/biz-okr/plans/:plan_id/objectives/:objective_id", requireEnabled, requirePlanEditor, recordOKRActivity(deps.Activity, okrActivitySpec{Surface: "plan", Action: "objective_saved", TargetParam: "objective_id"}, UpdateOKRPlanObjective(deps.Workspace)))
	h.PATCH("/api/biz-okr/plans/:plan_id/points/:point_id/definition", requireEnabled, requirePlanEditor, recordOKRActivity(deps.Activity, okrActivitySpec{Surface: "plan", Action: "point_definition_saved", TargetParam: "point_id"}, PatchPlanPointDefinition(deps.Workspace)))
	h.DELETE("/api/biz-okr/plans/:plan_id/objectives/:objective_id", requireEnabled, requirePlanEditor, recordOKRActivity(deps.Activity, okrActivitySpec{Surface: "plan", Action: "objective_deleted", TargetParam: "objective_id"}, DeleteOKRPlanObjective(deps.Workspace)))
	h.PUT("/api/biz-okr/plans/:plan_id/objectives/order", requireEnabled, requirePlanEditor, recordOKRActivity(deps.Activity, okrActivitySpec{Surface: "plan", Action: "objective_reordered", TargetParam: "plan_id"}, ReorderOKRPlanObjectives(deps.Workspace)))
	h.DELETE("/api/biz-okr/plans/:plan_id", requireEnabled, requirePlanEditor, recordOKRActivity(deps.Activity, okrActivitySpec{Surface: "plan", Action: "plan_deleted", TargetParam: "plan_id"}, DeleteOKRPlan(deps.Workspace)))
