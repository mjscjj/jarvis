...
func RegisterBizOKRModuleRoutes(h *server.Hertz, deps BizOKRModuleDependencies) error {
	...
	h.GET("/api/biz-okr/feedback", requireEnabled, requireIdentity, ListProductFeedback(deps.Workspace, deps.Identity.Enabled()))
	h.POST("/api/biz-okr/feedback", requireEnabled, requireIdentity, CreateProductFeedback(deps.Workspace, deps.Identity.Enabled()))
	h.POST("/api/biz-okr/feedback/:feedback_id/replies", requireEnabled, requireIdentity, ReplyProductFeedback(deps.Workspace, deps.Identity.Enabled()))
	h.PUT("/api/biz-okr/feedback/:feedback_id/plus-one", requireEnabled, requireIdentity, AddProductFeedbackPlusOne(deps.Workspace, deps.Identity.Enabled()))
	h.DELETE("/api/biz-okr/feedback/:feedback_id/plus-one", requireEnabled, requireIdentity, RemoveProductFeedbackPlusOne(deps.Workspace, deps.Identity.Enabled()))
	h.PATCH("/api/biz-okr/feedback/:feedback_id/status", requireEnabled, requireIdentity, SetProductFeedbackStatus(deps.Workspace, deps.Identity.Enabled()))
	...
	h.PATCH("/api/biz-okr/plans/:plan_id/krs/:kr_id", requireEnabled, recordOKRActivity(deps.Activity, okrActivitySpec{Surface: "plan", Action: "kr_saved", TargetParam: "kr_id"}, UpdateOKRPlanKR(deps.Workspace)))
	...
	h.DELETE("/api/biz-okr/regional-alignments/:region/demands/:demand_id", requireEnabled, requireIdentity, DeleteRegionalDemand(deps.Workspace))
	h.PUT("/api/biz-okr/regional-alignments/:region/decisions/:kr_id", requireEnabled, requireIdentity, PutRegionalDecision(deps.Workspace))
	h.PUT("/api/biz-okr/regional-alignments/:region/settings", requireEnabled, requireIdentity, PutRegionalSettings(deps.Workspace))
	h.PUT("/api/biz-okr/regional-alignments/:region/recap-order", requireEnabled, requireIdentity, PutRegionalRecapOrder(deps.Workspace))
	h.PATCH("/api/biz-okr/regional-alignments/:region/recap/:objective_id", requireEnabled, requireIdentity, PatchRegionalRecap(deps.Workspace))
	h.GET("/api/biz-okr/regional-alignments/:region/comments", requireEnabled, GetRegionalAlignmentComments(deps.Workspace))
	h.POST("/api/biz-okr/regional-alignments/:region/comments", requireEnabled, requireIdentity, CreateRegionalAlignmentComment(deps.Workspace))
