...
var (
	...
	ErrNoUserToken = errors.New("this person has no stored Feishu token; sign in to the OKR module again")
	...
	ErrUserTokenUnusable = errors.New("the stored Feishu token can no longer be refreshed; sign in to the OKR module again")
)
